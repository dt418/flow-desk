...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_MENTIONED', 'TASK_DUE_SOON', 'TASK_OVERDUE', 'TASK_COMPLETED', 'COMMENT_REPLY', 'WORKSPACE_INVITE', 'WORKSPACE_ROLE_CHANGED');
