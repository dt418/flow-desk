...
export function NewTaskModal({ open, onClose, workspaceId, columns, defaultColumnId, members }: Props) {
    ...
    >
      <div className="w-full max-w-md rounded-xl border border-[var(--border)] bg-[var(--bg)] p-5 shadow-xl">
        <div className="mb-4 flex items-center justify-between">
          <h3 id="new-task-title" className="text-[14px] font-semibold tracking-tight">
            New task
          </h3>
          <button
            type="button"
